...
var allRemoteParticipantRoomEvents = [
  ...
  import_livekit_client2.RoomEvent.ParticipantNameChanged,
  import_livekit_client2.RoomEvent.ParticipantAttributesChanged,
...
function createChatObserver(room) {
  return roomEventSelector(room, import_livekit_client9.RoomEvent.ChatMessage);
}
...
function encryptionStatusObservable(room, participant) {
  return roomEventSelector(room, import_livekit_client9.RoomEvent.ParticipantEncryptionStatusChanged).pipe(
    ...
    (0, import_rxjs2.startWith)(
      participant instanceof import_livekit_client9.LocalParticipant ? participant.isE2EEEnabled : !!(participant == null ? void 0 : participant.isEncrypted)
    )
  );
}
function recordingStatusObservable(room) {
  return roomEventSelector(room, import_livekit_client9.RoomEvent.RecordingStatusChanged).pipe(
...
function participantAttributesObserver(participant) {
  ...
  return participantEventSelector(participant, import_livekit_client10.ParticipantEvent.AttributesChanged).pipe(
...
function setupChat(room, options) {
  ...
  const serverSupportsChatApi = () => {
    var _a2, _b2, _c;
    return ((_a2 = room.serverInfo) == null ? void 0 : _a2.edition) === 1 || !!((_b2 = room.serverInfo) == null ? void 0 : _b2.version) && (0, import_livekit_client14.compareVersions)((_c = room.serverInfo) == null ? void 0 : _c.version, "1.17.2") > 0;
  };
